...
knop = tk.Button(text='knop', bg="red", fg="white",command=knop_switch,height=1,width=15)
knop.pack()
titel = tk.Label(text="gemaakt door Bram",bg="blue",fg="white",height=1,width=20)
titel.pack(side="top")
